...
def mostrar_vendedores_maua(conn_faturamento):
    st.title("Vendedores - Mauá")

    col1, col2, col3 = st.columns([1, 1, 2])
    with col1:
        data_inicio = st.date_input("Data Inicial", value=date.today(), key="data_inicio_vendedores_maua")
    with col2:
        data_fim = st.date_input("Data Final", value=date.today(), key="data_fim_vendedores_maua")
    ...
    if st.button("🔙 Voltar", key="voltar_vendedores_maua"):
